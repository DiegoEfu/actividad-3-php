...
<body style="background: black;">
    ...
    <div class="row g-1 d-flex justify-content-center mt-2" style="max-width: 100%;">
        ...
        <div class="col-8 border">
            <textarea form="guardarForm" name="texto" id="texto"  rows="10" class="w-100 h-100 bg-dark text-white"></textarea>    
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="guardarForm" action="guardar.php" method="post">
                        <input class="form-control" pattern="(^[a-zA-Z0-9_.\-\(\)])([a-zA-Z0-9_.\-\(\)\/\\])+\.(.[\w]+)$" type="text" name="nombre_archivo" id="nombre_archivo" placeholder="Dirección del Archivo" required>
